...
public:
    ...
    {
        // Eidas: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // Eidas: get transaction coin age
...
public:
    ...
    // Eidas: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Eidas: entropy bit for stake modifier if chosen by modifier
    ...
    // Eidas: two types of block: proof-of-work or proof-of-stake
    ...
    // Eidas: get max transaction timestamp
