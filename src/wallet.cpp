...
// Eidas: optional setting to unlock wallet for block minting only;
    ...
    // restored from backup or the user making copies of wallet.dat.
    {
        ...
        BOOST_FOREACH(const CTxIn& txin, tx.vin)
        {
            ...
            if (mi != mapWallet.end())
            {
                ...
                {
                    printf("WalletUpdateSpent found spent coin %sEDS %s\n", FormatMoney(wtx.GetCredit()).c_str(), wtx.GetHash().ToString().c_str());
...
// Eidas: total coins staked (non-spendable until maturity)
		...
		
    {
        ...
        CTxDB txdb("r");
        {
            ...
            for (;;)
            {
                ...
                // Eidas: sub-cent change is moved to fee
...
// Eidas: create coin stake transaction
...
// Eidas: check 'spent' consistency between wallet and txindex
// Eidas: fix wallet spent state according to txindex
...
// Eidas: disable transaction (only for coinstake)
